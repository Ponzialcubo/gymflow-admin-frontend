        ...
        <form onSubmit={handleUpdatePassword} className="space-y-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-6 border-t border-slate-100">
            <div className="flex items-center gap-4 text-slate-500">
              ...
              {/* Texto de aviso aumentado a text-sm */}
            ...
            {/* Botón aumentado a text-sm */}
            <button type="submit" className="w-full md:w-auto px-10 py-5 bg-slate-900 text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-blue-600 transition-all shadow-xl active:scale-95 shrink-0">
              Actualizar Clave
            </button>
          </div>
        </form>
