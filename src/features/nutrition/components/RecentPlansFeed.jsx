      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {recientes.length > 0 ? (
          recientes.map(r => (
            <div 
              key={r.id} 
              className="p-4 rounded-3xl border border-slate-100 flex items-center gap-4 hover:border-emerald-200 hover:bg-emerald-50/10 transition-all animate-in fade-in zoom-in duration-500"
            >
