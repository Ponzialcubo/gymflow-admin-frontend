...
export default function ClientMeasurementsModal({ isOpen, onClose, onSubmit, newMedicion = {}, setNewMedicion, usuarioNombre }) {
  ...
  // 1. Calculamos el IMC en tiempo real
  ...
  // 2. ¡EL TRUCO! Guardamos el IMC automáticamente en el estado para que el botón "Guardar" lo envíe
  useEffect(() => {
    if (imcCalculado !== '--' && newMedicion.imc !== imcCalculado) {
      setNewMedicion(prev => ({ ...prev, imc: imcCalculado }));
    }
  }, [imcCalculado, setNewMedicion]);
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-md flex items-center justify-center z-[100] p-4">
      <div className="bg-white rounded-[3rem] p-10 w-full max-w-md shadow-2xl animate-in zoom-in duration-300">
        ...
        {/* Volvemos a tu onSubmit original para que el hook procese el evento correctamente */}
